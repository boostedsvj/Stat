...
for iMean,mean in enumerate(means):
    ...
    for iSigma,sigma in enumerate(sigmas):
        ...
        sfile = r.TFile.Open("fitDiagnosticsbias_"+ename+region+"_"+hname+".root")
        ...
        gaus.Draw("same")
#        hist.SetLineColor(colors[iSigma])
#        hist.Draw("hist same")
#        can.Update()
    can.Update()
    can.Print("plotBiases_svj_"+ename+region+"_m{}.png".format(iMean),"png")
...
g_mu.Draw("ap")
cang.Print("biasMu_svj_"+ename+region+"_m{}.png".format(iMean),"png")
...
g_sigma.Draw("ap")
cang.Print("biasSigma_svj_"+ename+region+"_m{}.png".format(iMean),"png")
