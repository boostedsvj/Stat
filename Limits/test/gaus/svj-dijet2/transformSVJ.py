...
infile = r.TFile.Open("root://cmseos.fnal.gov//store/user/pedrok/SVJ2017/gaus/svj-dijet2/ws_SVJ_mZprime3000_mDark20_rinv03_alphapeak_"+region+"_2018_template.root","READ")
...
# make new pdfs
roomultipdf = w.pdf("roomultipdf")
pnew = r.RooParametricShapeBinPdf(
    "para_shape",
    "para shape for bkg",
    w.pdf("roomultipdf"),
    mT,
    r.RooArgList(roomultipdf.getParameters(pdat)),
    hdat
)
