...
if [[ "$extra" == "extra" ]]; then
  ...
  ENAME="svjOpt_"
elif [[ "$extra" == "extra2" ]]; then
  EXTRA="--robustFit=1 --setRobustFitTolerance=1. --setRobustFitAlgo Minuit2,migrad --cminDefaultMinimizerStrategy 0 --cminDefaultMinimizerType Minuit --cminDefaultMinimizerAlgo Simplex"
  ENAME="combOpt_"
fi
